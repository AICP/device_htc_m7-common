...
public class WakeMethod implements OnPreferenceChangeListener {
    ...
    private static final String METHOD_DOUBLETAP = "2";
    private static final String METHOD_BOTH = "3";

    public static boolean isSupported() {
        return Utils.fileExists(FILE_S2W) && Utils.fileExists(FILE_DT2W);
    }
